...
(function ($) {
  ...
  function submit_dialog_job(dialog, data) {
  ...
  $(function () {
    ...
    global_open_job_dialog = function (val) {
      open_job_dialog(val, true)
    }
