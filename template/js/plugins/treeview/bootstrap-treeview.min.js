    ...
    Tree.prototype = {
        ...
        _buildTree: function(nodes, level) {
            ...
            $.each(nodes, function addNodes(id, node) {
                ...
                // Add tags as badges
                var container = treeItem;
                if ( self.options.tagContainer ) {
                    container = $(self.options.tagContainer);
                    treeItem.append(container)
                }
                if (self.options.showTags && node.tags) {
                    $.each(node.tags, function addTag(id, tag) {
            var markup = self._template.badge;
            var tag_value = tag;
            if ( tag.markup !== undefined ) {
              ...
              tag_value = tag.value;
                    ...
                    container.append($(markup).append(tag_value));
